...
// Change scroll distance to match HeroText component (500vh)
const SCROLL_EXTRA_PX = typeof window !== 'undefined' ? 500 * window.innerHeight : 500 * 1080; // Fallback for SSR
