...
const RitualReversed: React.FC<RitualReversedProps> = ({
  ...
  if (isMobile) {
    return (
      <div className="grid grid-cols-12 gap-8 mb-16 last:mb-0 relative" style={{
        zIndex: 10
      }}>
        ...
        <div className="col-span-12 md:col-span-5 md:col-start-8 md:col-end-11 flex flex-col justify-center relative" style={{
          ...
          <div className="space-y-4">
            {description.map((paragraph, idx) => (
              <p key={idx} className="body-text text-center md:text-left" style={{
                color: colors.darkGreen
              }}>
                {paragraph}
              </p>
  ...
  return (
    <div className="grid grid-cols-12 gap-8 mb-16 last:mb-0 relative" style={{
      ...
      <div style={{
        zIndex: 15
      }} className="col-span-12 md:col-span-5 md:col-start-2 md:col-end-5 flex flex-col justify-center relative">
        <h2 className="title-md mb-6 text-center md:text-left" style={{
          color: colors.darkGreen
        }}>
          {title}
