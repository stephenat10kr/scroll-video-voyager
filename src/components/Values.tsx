...
const Values: React.FC<ValuesProps> = ({
  ...
  return (
    <>
      ...
      <div 
        className="fixed top-0 left-0 w-full h-full opacity-85 z-[-1]"
        style={{
          backgroundImage: `
            linear-gradient(135deg, rgba(14, 165, 233, 0.85) 0%, rgba(14, 165, 233, 0.8) 100%),
      ...
      <div 
        className="fixed top-0 left-0 w-full h-full opacity-20 z-[-2]"
        style={{
