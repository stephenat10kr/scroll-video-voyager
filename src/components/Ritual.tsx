...
const Ritual: React.FC<RitualProps> = ({
  ...
  return (
    <div className="grid grid-cols-12 gap-8 mb-16 last:mb-0">
      {/* Image Section - always spans columns 1-5 when not reversed, columns 8-12 when reversed */}
      ...
      {/* Text Section - always spans columns 8-12 when not reversed, columns 1-5 when reversed */}
