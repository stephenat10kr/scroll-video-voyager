        ...
        <div className="grid grid-cols-12 gap-12">
          <div className="">
            ...
            if (carouselApi) {
              ...
              <CarouselContent>
                {mediaItems?.map((item, index) => <CarouselItem key={index}>
          ...
          <div className="col-start-5 col-end-13 space-y-6 text-white">
            ...
            <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="inline-block text-sm underline hover:text-gray-300 transition-colors">
              {address}
            </a>
          </div>
        </div>
