...
const Spinner: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Scale factor controls rotation speed relative to scroll amount
      const scaleFactor = 0.5; 
      rotationRef.current += scrollDelta * scaleFactor;
  ...
  return (
    <div className="flex flex-col items-center my-8">
      <svg 
        ...
        className="transition-transform duration-300 ease-out mb-3 will-change-transform"
