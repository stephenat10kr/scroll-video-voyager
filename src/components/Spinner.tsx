...
const Spinner: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const animation = gsap.to(spinnerRef.current, {
      rotation: (i, target) => {
        // This function determines rotation direction and amount
        return `+=${scrollDirection === "up" ? -360 : 360}`; 
      },
      ease: "power2.out", // Smoother easing for better feel
      scrollTrigger: {
        ...
        scrub: 1.5, // Smoother scrubbing with 1.5 second lag for better easing
        toggleActions: "play none none reverse", // Controls the playback
        onUpdate: (self) => {
    ...
    return () => {
      // Clean up animation and event listener when component unmounts
  ...
  return (
    <div className="flex flex-col items-center my-8">
      <svg 
        ...
        className="transition-transform mb-3 will-change-transform" // Added will-change for better performance
      >
        <path 
