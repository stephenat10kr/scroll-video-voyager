...
const Index = () => {
  return (
    <div className="bg-[#203435] min-h-screen w-full relative">
      {/* Fixed blue background - at the lowest z-index but with full opacity */}
      <div className="fixed top-0 left-0 w-full h-full" style={{ zIndex: -1 }}>
        {/* Main blue background with pattern - increased opacity to 100% */}
        <div 
          className="w-full h-full"
          style={{
            backgroundImage: `
              linear-gradient(135deg, rgba(14, 165, 233, 1) 0%, rgba(14, 165, 233, 0.95) 100%),
        ...
        {/* Noise texture overlay - slightly reduced opacity for better visibility of the blue */}
        <div 
